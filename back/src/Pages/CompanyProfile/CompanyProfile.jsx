  ...
  return (
    <>
      ...
      <div className="container mt-5 pt-4 mb-5 pb-5">
        {/* <button
          onClick={() =>
            console.log("fffff", props.companyinfoReducer.companyinfo)
          }
        >
          fffff
        </button> */}
        ...
        >
          <div className="col-md-2 col-3 company-profile-pic ">
            ...
            props.companyinfoReducer.companyinfo.dp !== "" ? (
              <img
                src={props.companyinfoReducer.companyinfo.dp}
                height="100%"
                width="70%"
          ...
          <div className="col-md-8 col-9 pl-lg-4 pl-md-4  pt-2 my-auto">

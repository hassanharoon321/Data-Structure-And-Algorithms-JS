        ...
        <div className="row mb-3">
          <div className="col-md-12">
            ...
            <h6 className="posted-jobs-rexr-para">
              Showing {props.alljobsReducer.alljobs.jobs?props.alljobsReducer.alljobs.jobs.length:"0"} Posted Jobs
            </h6>
          </div>
        </div>
        <div className="row">
          <div className="col-md-9">
            {/* Apis Start here */}
            {
              ...
              props.alljobsReducer.alljobs.jobs.map(alljobs=>(
                ...
                <div className="col-md-12 text-right"><a href="#" onClick={(e)=>deletefunc(alljobs.id)} style={{textDecoration:"none"}}> <p className="pb-0 mb-0 text-danger text-right">Delete Job</p></a></div>
                <Link to={`/PostedJobsDesc?id=${alljobs.id}`} className="link-tag-home">
                <div className="row">

...
class Messaging extends React.PureComponent {
  ...
  getAllChatMessages = async () => {
    await getAllChats()
      ...
      .then((response) => {
        ...
        if (
          JSON.stringify(response.data.all_chats) !==
          JSON.stringify(this.state.allChats)
        ) {
          this.setState({
  ...
  singleUserMessage = async (chatId, userrId, username, userImg) => {
    ...
    await getSpecificChat(chatId)
      ...
      .then((response) => {
        ...
        if (
          JSON.stringify(response.data.all_messages) !==
          JSON.stringify(this.state.allMsgs)
        ) {
          this.setState({
  ...
  sendMessage = async () => {
    if (
      this.state.msgText == "" ||
      this.state.msgText == null ||
      this.state.msgText == undefined
    ) {
  ...
  reportMeassage = async () => {
    this.setState({reportMesage:false})
    await reportMesage(this.state.chattId)
      .then((res) => res.json())
      .then((response) => {
  ...
  deleteMeassage = async () => {
    await deleteMessage(this.state.chattId)
      .then((res) => res.json())
      .then((response) => {
        window.location.reload(false);
      })
  ...
  sendMessagetoNewUser = async (id, cid) => {
    ...
    await sendMessages(chaId, id, this.state.msgText)
      .then((res) => res.json())
      .then((response) => {
        ...
        var cid =
          query.length == 4
            ? this.props.location.search.split("?")[2].split("=")[1]
            : undefined;
        var nameOfNewUser =
          query.length == 3
            ? this.props.location.search.split("?")[2].split("=")[1]
            : query.length == 4
            ? this.props.location.search.split("?")[3].split("=")[1]
            : undefined;
  ...
  componentDidMount() {
    ...
    var user =
      query.length == 3
        ? this.props.location.search.split("?")[1].split("user=")[1]
        : query.length == 4
        ? this.props.location.search.split("?")[1].split("user=")[1]
        : undefined;
    var chat =
      query.length == 4
        ? this.props.location.search.split("?")[2].split("chat=")[1]
        : undefined;
    var nameOfNewUser =
      query.length == 3
        ? this.props.location.search.split("?")[2].split("f_n_ame=")[1]
        : query.length == 4
        ? this.props.location.search.split("?")[3].split("f_n_ame=")[1]
        : undefined;
  ...
  render() {
    const { allChats, allMsgs, chattId, userrId, msgText, userName, userImg } =
      this.state;
    var query = this.props.location.search.split("?");
    console.log(query);
    var id =
      query.length == 3
        ? this.props.location.search.split("?")[1].split("id=")[1]
        : query.length == 4
        ? this.props.location.search.split("?")[1].split("id=")[1]
        : query.length == 2
        ? this.props.location.search.split("?")[1].split("id=")[1]
    ...
    var cid =
      query.length == 4
        ? this.props.location.search.split("?")[2].split("cid=")[1]
        : undefined;
    var nameOfNewUser =
      query.length == 3
        ? this.props.location.search.split("?")[2].split("name=")[1]
        : query.length == 4
        ? this.props.location.search.split("?")[3].split("name=")[1]
        : undefined;
    console.log("wwwwww", query, id, cid);
    const helloName = ()=>{
      allChats.map((data)=>{
    ...
    return (
      <>
        ...
        <div className="container py-5 px-4">
          {/* <button onClick={()=>console.log("some",userName)}>buttonn</button> */}
                      ...
                      <div className="row">
                        ...
                        >
                          <i
                            ...
                            onClick={() => this.sendMessagetoNewUser(id, cid)}
                          ></i>
                          {/* <img 

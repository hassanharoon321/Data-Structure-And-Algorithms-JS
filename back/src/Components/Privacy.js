  ...
  return (
    <>
      ...
      <div className="container mt-5">
        <h1 className="terms-and-cond-head">Privacy Policy</h1>
        <p>
        ...
        <h6>Usage and Information Collection by CV Vlogs</h6>
        <p>
        ...
        <h6>Our Use of your Information</h6>
        <p>
        ...
        <h6>Personal Information on Resumes and Profiles</h6>
        <p>
        ...
        <p>
          ...
          VLOGS at any time, but, employers, recruiters and others who have
        ...
        <h6>Posting to Public Areas of CV Vlogs</h6>
        <p>
        ...
        <h6>Modification of Your Information</h6>
        <p>
        ...
        <h6>Security of the Profile Information</h6>
        <p>
        ...
        <h6>Children's use of CV Vlogs</h6>
        <p>
        ...
        <h6>Privacy Policy Modifications</h6>
        <p>

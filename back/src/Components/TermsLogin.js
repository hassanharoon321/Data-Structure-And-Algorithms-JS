    ...
    return (
        <>
            ...
            <div className="container mt-5">
                <h1 className="terms-and-cond-head">Terms and Conditions</h1>
                <h6>OVERVIEW OF TERMS</h6>
        <p>
        ...
        <p>
          You hereby confirm to CV Vlogs that: (a) you have reached the age of
        ...
        <h6>COMMUNICATION AMONG USERS</h6>
        <p>
        ...
        <p>
          ...
          by CV Vlogs with regards toٖ:
        </p>
        <h6>HARRASMENT AND THEFT POLICY</h6>
        <p>
